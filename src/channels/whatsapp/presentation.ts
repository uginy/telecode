...
export function renderWhatsappTaskReviewCompact(
	result: TaskReviewSummary,
): string {
	const parts = [
		result.outcome === "completed"
			? "Last task completed"
	...
	parts.push("Use /review for details.");
	return parts.join("\n");
}
